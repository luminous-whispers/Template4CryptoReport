...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{pic/callback-\detokenize\expandafter{\labno}-1.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{pic/test-\detokenize\expandafter{\labno}-1.png} 
